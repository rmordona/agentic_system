// File: src/app/views/WorkspaceCardView.tsx
...
const WorkspaceCardView: React.FC<WorkspaceCardProps> = ({ workspace, onClick }) => {
  return (
    <div
      onClick={onClick}
    ...
    >
      ...
      <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
        {workspace.stages && workspace.stages.length > 0 ? 'Has Stages' : 'No Stages'}
      </p>
    </div>
  )
}
